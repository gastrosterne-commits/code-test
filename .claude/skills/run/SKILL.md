---
name: run
description: Startet die Bewerbungs-Automatisierung mit einem wählbaren Filter-Profil aus filters.json. Argument: Profilname (z.B. hamburg, frankfurt, standard, neu_seit_heute).
allowed-tools: Read, Edit, Bash
argument-hint: [profilname]
---
